...
public class Main {
    ...
    public static int[] heroesHealth = {260, 250, 270, 350, 400, 100, 300, 280};
    public static int[] heroesDamage = {15, 20, 10, 0, 5, 10, 25, 15};
    public static String[] heroesAttackType = {

            "Physical", "Magical", "Kinetic", "Medical", "Golem", "Lucky", "Thor", "Berserk"};
    ...
    public static void Golem() {
        Random random = new Random();
        boolean superOfGolemIsTrue = random.nextBoolean();
        if (superOfGolemIsTrue && heroesHealth[5] >0) {
            bossDamage = 0;
            System.out.println("Boss is stunned ");
        } else if (!(superOfGolemIsTrue) && heroesHealth[5] > 0) {
